<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Beograd.aspx.cs" Inherits="B11.Uputstvo" %>
    ...
    <form id="form1" runat="server">
        <div>
			...
			<br/><br/><br/>
				<h1>Београд</h1>
				<br />
				Дом Мике Аласа, зграда Патријаршије, дом ЈНА, Гардош кула, дом Светог Саве, Народно позориште...
			</center>
